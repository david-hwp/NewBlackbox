...
public class PendingShopDeductResponse {
    private Shop shop;
    ...
    public PendingShopDeductResponse() {
    }

    public static PendingShopDeductResponse from(Shop shop, User user, boolean deducted) {
        PendingShopDeductResponse response = new PendingShopDeductResponse();
