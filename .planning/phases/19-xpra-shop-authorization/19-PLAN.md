...
- [19-LEGACY-PLAN.md](19-LEGACY-PLAN.md) 保留原叙述型计划、服务器排查记录和 Wave 1-3 验证流水。新执行和后续维护应以 `19-01-PLAN.md` 到 `19-04-PLAN.md` 为准。
...
Wave 1-3 已完成并作为历史基线保留。下一次执行 Phase 19 时应只执行 Wave 4，除非用户明确要求重放旧 wave。
